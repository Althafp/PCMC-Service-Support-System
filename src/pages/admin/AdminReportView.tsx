...
import { ArrowLeft, FileText, MapPin, Calendar, User, CheckCircle, XCircle, Clock, Users } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">View complete report information</p>
          </div>
        </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div>
                  ...
                  <p className="text-blue-900">{report.technician?.full_name || 'Unassigned'}</p>
                </div>
                <div>
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div>
                  ...
                  <p className="text-green-900">{(report as any).technician?.teamLeaderName || 'Unassigned'}</p>
                </div>
                <div>
                  <span className="text-green-700 font-medium">Employee ID:</span>
                  <p className="text-green-900">{(report as any).technician?.team_leader_id || 'N/A'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-orange-50 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div>
                  ...
                  <p className="text-orange-900">{(report as any).technician?.managerName || 'Unassigned'}</p>
                </div>
                <div>
                  <span className="text-orange-700 font-medium">Employee ID:</span>
                  <p className="text-orange-900">{(report as any).technician?.manager_id || 'N/A'}</p>
                </div>
              </div>
            </div>
          </div>
