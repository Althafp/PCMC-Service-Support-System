...
export function TeamManagement() {
  ...
  const fetchTeamMembers = async () => {
    ...
    try {
      console.log('Fetching team members for manager:', user.id, user.full_name);
      
      // Use the new service to get team members
      const { data: teamMembersData, error } = await userService.getManagerTeam(user.id);
      if (error) throw error;
      
      console.log('Team members found:', teamMembersData.length);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600">Manage and monitor your team leaders and members</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">
                {teamMembers.filter(m => m.role === 'team_leader').length}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">
                {teamMembers.filter(m => m.role === 'technician' || m.role === 'technical_executive').length}
              </p>
            </div>
          </div>
        </div>
